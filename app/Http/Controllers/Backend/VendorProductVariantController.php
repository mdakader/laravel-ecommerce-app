...
class VendorProductVariantController extends Controller
{
    ...
    public function index(VendorProductVariantDataTable $dataTable, string $productId)
    {
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.products-variant.index', ['productId' => $request->product]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('vendor.products-variant.index', ['productId' => $varinat->product_id]);
    }
