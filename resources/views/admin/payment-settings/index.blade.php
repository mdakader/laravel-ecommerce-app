                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="list-group" id="list-tab" role="tablist">
                                        <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab">Stripe</a>
                                        <a class="list-group-item list-group-item-action" id="list-paypal-list" data-toggle="list" href="#list-paypal" role="tab">Paypal</a>
